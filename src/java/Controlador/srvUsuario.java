...
public class srvUsuario extends HttpServlet {
    ...
    private void verificar(HttpServletRequest request, HttpServletResponse response) throws Exception{
        ...
        }else if(usuario != null && usuario.getCargo().getNombreCargo().equals("ALMACENERO")){
           sesion = request.getSession();
            sesion.setAttribute("almacenero", usuario);
            this.getServletConfig().getServletContext().getRequestDispatcher("/vistas/formAlmacenero.jsp").forward(request, response); 
        }else{
