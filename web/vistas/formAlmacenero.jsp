...
<%
    if (session.getAttribute("almacenero") != null) {
%>
<html>
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>Sistema IJ | Almacenero</title>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs">${almacenero.nombreUsuario}</span>
                                </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        ...
                                        <p>                    
                                            Bienvenido - ${almacenero.nombreUsuario}
                                            <small>Usted es, ${almacenero.cargo.nombreCargo} </small>
                                        </p>
                                    </li>
                                    <!-- Menu Footer-->
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p>Bienvenido, ${almacenero.nombreUsuario}</p>
                            <!-- Status -->
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="active"><a href="#"><i class="fa fa-file-text"></i> <span>REPORTES</span></a></li>
                        <li class="treeview">
                            <a href="#"><i class="fa fa-"></i> <span>CLIENTES</span>
